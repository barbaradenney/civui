...
describe('generateGovForm', () => {
  it('generates a complete form for 21-526EZ', () => {
    const result = generateGovForm('21-526EZ');
  ...
  it('throws for unknown form number', () => {
    expect(() => generateGovForm('99-FAKE')).toThrow('Unknown form');
  });

  it('generates 10-10EZ healthcare form', () => {
    const result = generateGovForm('10-10EZ');
  ...
  it('generates 22-1990 education form', () => {
    const result = generateGovForm('22-1990');
  ...
  it('generates 21P-527EZ pension form', () => {
    const result = generateGovForm('21P-527EZ');
