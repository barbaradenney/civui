...
export const DeclarativeValidation: Story = {
  ...
  render: () => html`
    <div class="civ-flex civ-flex-col civ-gap-4 civ-max-w-lg">
      <civ-text-input label="Email" name="email" validate="email" required hint="We'll send your confirmation here"></civ-text-input>
      <civ-text-input label="Social Security number" name="ssn" validate="ssn" required mask="ssn" type="tel"></civ-text-input>
      <civ-text-input label="ZIP code" name="zip" validate="zip" required mask="zip" inputmode="numeric"></civ-text-input>
    </div>
  `,
};
...
export const FormValidation: Story = {
  ...
  render: () => html`
    ...
    >
      ...
      <civ-text-input label="Phone" name="phone" type="tel"
        validate="phone" hint="US phone number"></civ-text-input>
