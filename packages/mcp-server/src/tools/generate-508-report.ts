...
const RULE_TO_WCAG: Record<string, WcagMapping> = {
  ...
  'form-steps-missing-progress': { criterion: '2.4.8', name: 'Location', level: 'AAA' },
  ...
  'form-steps-step-gap': { criterion: '2.4.8', name: 'Location', level: 'AAA' },
  'form-steps-step-no-fields': { criterion: '3.3.2', name: 'Labels or Instructions', level: 'A' },
...
const EFFORT_MAP: Record<string, 'trivial' | 'small' | 'medium'> = {
  ...
  'form-steps-missing-progress': 'small',
  'repeatable-no-aria-live': 'trivial',
  'repeatable-no-min': 'trivial',
  'form-steps-step-gap': 'trivial',
  'form-steps-step-no-fields': 'small',
