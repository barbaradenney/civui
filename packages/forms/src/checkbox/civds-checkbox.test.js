...
describe('civds-checkbox', () => {
    ...
    it('renders description text', async () => {
        const el = createFixture('<civds-checkbox label="Agree" description="By checking this you agree to our terms"></civds-checkbox>');
        await waitForUpdate(el);
    ...
    it('has static formAssociated = true', () => {
        const Ctor = customElements.get('civds-checkbox');
...
//# sourceMappingURL=civds-checkbox.test.js.map