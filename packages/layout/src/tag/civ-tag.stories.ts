...
export const Default: Story = {
  ...
  render: (args) => html`<civ-tag label="${args.label}" color="${args.color}" tag-style="${args.tagStyle || 'secondary'}"></civ-tag>`,
};
...
export const Primary: Story = {
  render: () => html`
    <div class="civ-flex civ-gap-2 civ-flex-wrap civ-items-center">
      ...
      <civ-tag label="Education" color="orange" tag-style="primary"></civ-tag>
      <civ-tag label="Disability" color="purple" tag-style="primary"></civ-tag>
      <civ-tag label="Archived" color="gray" tag-style="primary"></civ-tag>
    </div>
  `,
};
...
export const Secondary: Story = {
  render: () => html`
    <div class="civ-flex civ-gap-2 civ-flex-wrap civ-items-center">
      ...
      <civ-tag label="Disability" color="purple"></civ-tag>
...
export const WithIcons: Story = {
  ...
  render: () => html`
    <div class="civ-flex civ-gap-2 civ-flex-wrap civ-items-center">
      ...
      <civ-tag label="Important" color="purple" icon-start="star" tag-style="primary"></civ-tag>
      <civ-tag label="Mailed" color="orange" icon-start="mail"></civ-tag>
      <civ-tag label="Locked" color="gray" icon-start="lock" tag-style="primary"></civ-tag>
    </div>
  `,
};
  ...
  render: () => html`
    <div class="civ-flex civ-flex-col civ-gap-3">
      ...
      <div class="civ-flex civ-gap-2 civ-flex-wrap">
        <civ-tag label="Healthcare" color="blue"></civ-tag>
        <civ-tag label="Education" color="orange"></civ-tag>
        <civ-tag label="Housing" color="purple"></civ-tag>
        <civ-tag label="Employment" color="gray"></civ-tag>
      </div>
    </div>
  `,
};
  ...
  render: () => html`
    <div class="civ-flex civ-flex-col civ-gap-6">
      ...
      <div>
        ...
        <div class="civ-flex civ-gap-2 civ-flex-wrap">
          <civ-tag label="Healthcare" color="blue" tag-style="primary" spacing="sm"></civ-tag>
          <civ-tag label="Education" color="orange" spacing="sm"></civ-tag>
          <civ-tag label="Disability" color="purple" tag-style="primary" spacing="sm"></civ-tag>
        </div>
      </div>
    </div>
  `,
