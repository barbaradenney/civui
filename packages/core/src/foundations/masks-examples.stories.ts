...
export const CustomPatterns: Story = {
  ...
  render: () => html`
    <div class="civ-flex civ-flex-col civ-gap-4 civ-max-w-lg">
      <civ-text-input label="Case number" name="case" mask-pattern="AA-####" hint="For example: AB-1234"></civ-text-input>
      <civ-text-input label="License plate" name="plate" mask-pattern="AAA-####" hint="For example: ABC-1234"></civ-text-input>
    </div>
  `,
};
...
export const MaskModes: Story = {
  ...
  render: () => html`
    <div class="civ-flex civ-flex-col civ-gap-4 civ-max-w-lg">
      <civ-text-input label="Phone (blur mode — default)" name="phone1" mask="phone-us" type="tel" hint="Type freely, formatted on blur"></civ-text-input>
      <civ-text-input label="Phone (live mode)" name="phone2" mask="phone-us" mask-mode="live" type="tel" hint="Formatted as you type"></civ-text-input>
    </div>
  `,
};
