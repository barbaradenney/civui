...
4. **Underline geometry tokens** — replace the two hardcoded `text-underline-offset` values with `--civ-typography-underline-offset` and `--civ-typography-underline-thickness`, apply uniformly across links. ~15 lines.
