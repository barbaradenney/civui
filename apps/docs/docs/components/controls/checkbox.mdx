...
> **Contract reference:** [`civ-checkbox`](/contract/civ-checkbox) · [`civ-checkbox-group`](/contract/civ-checkbox-group) — auto-generated structured contract for cross-platform implementation.
