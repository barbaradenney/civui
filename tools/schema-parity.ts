...
export const COVERED_COMPONENTS: ComponentSpec[] = [
  ...
  { name: 'civ-checkbox',          source: 'packages/inputs/src/checkbox/civ-checkbox.ts',           isBoolean: true,                ios: 'packages/ios/Sources/CivUI/CivCheckbox.swift',         android: 'packages/android/src/main/kotlin/gov/civui/components/CivCheckbox.kt',         drupal: 'packages/drupal/civui/components/checkbox/checkbox.component.yml' },
  { name: 'civ-radio-group',       source: 'packages/inputs/src/radio/civ-radio-group.ts',                                          ios: 'packages/ios/Sources/CivUI/CivRadio.swift',                                                                                                drupal: 'packages/drupal/civui/components/radio-group/radio-group.component.yml' },
  { name: 'civ-radio',             source: 'packages/inputs/src/radio/civ-radio.ts',                                                ios: 'packages/ios/Sources/CivUI/CivRadio.swift',            android: 'packages/android/src/main/kotlin/gov/civui/components/CivRadio.kt',            drupal: 'packages/drupal/civui/components/radio/radio.component.yml' },
  ...
  { name: 'civ-checkbox-group',    source: 'packages/inputs/src/checkbox/civ-checkbox-group.ts',                                    ios: 'packages/ios/Sources/CivUI/CivCheckboxGroup.swift',    android: 'packages/android/src/main/kotlin/gov/civui/components/CivCheckboxGroup.kt',    drupal: 'packages/drupal/civui/components/checkbox-group/checkbox-group.component.yml' },
  ...
  { name: 'civ-segmented-control', source: 'packages/inputs/src/segmented-control/civ-segmented-control.ts',                       ios: 'packages/ios/Sources/CivUI/CivSegmentedControl.swift', android: 'packages/android/src/main/kotlin/gov/civui/components/CivSegmentedControl.kt', drupal: 'packages/drupal/civui/components/segmented-control/segmented-control.component.yml' },
  { name: 'civ-segment',           source: 'packages/inputs/src/segmented-control/civ-segment.ts',                                  ios: 'packages/ios/Sources/CivUI/CivSegmentedControl.swift', android: 'packages/android/src/main/kotlin/gov/civui/components/CivSegmentedControl.kt' },
  ...
  { name: 'civ-filterable-list',   source: 'packages/data/src/filterable-list/civ-filterable-list.ts',                                ios: 'packages/ios/Sources/CivUI/CivFilterableList.swift',   android: 'packages/android/src/main/kotlin/gov/civui/components/CivFilterableList.kt',   drupal: 'packages/drupal/civui/components/filterable-list/filterable-list.component.yml' },
  ...
  // civ-form-autosave is a JS-only orchestration utility — the iOS / Android
  // stubs are placeholders that exist only to satisfy the cross-platform
  // parity contract. Native apps wire UserDefaults / DataStore in app code.
  { name: 'civ-form-autosave',     source: 'packages/form-patterns/src/autosave/civ-form-autosave.ts',                                                    ios: 'packages/ios/Sources/CivUI/CivFormAutosave.swift',     android: 'packages/android/src/main/kotlin/gov/civui/components/CivFormAutosave.kt',     drupal: 'packages/drupal/civui/components/form-autosave/form-autosave.component.yml' },
  ...
  { name: 'civ-breadcrumb',        source: 'packages/navigation/src/breadcrumb/civ-breadcrumb.ts',                                    ios: 'packages/ios/Sources/CivUI/CivBreadcrumb.swift',     android: 'packages/android/src/main/kotlin/gov/civui/components/CivBreadcrumb.kt',     drupal: 'packages/drupal/civui/components/breadcrumb/breadcrumb.component.yml' },
  { name: 'civ-breadcrumb-item',   source: 'packages/navigation/src/breadcrumb/civ-breadcrumb-item.ts',                               ios: 'packages/ios/Sources/CivUI/CivBreadcrumbItem.swift', android: 'packages/android/src/main/kotlin/gov/civui/components/CivBreadcrumbItem.kt', drupal: 'packages/drupal/civui/components/breadcrumb-item/breadcrumb-item.component.yml' },
  { name: 'civ-nav',               source: 'packages/navigation/src/nav/civ-nav.ts',                                                  ios: 'packages/ios/Sources/CivUI/CivNav.swift',            android: 'packages/android/src/main/kotlin/gov/civui/components/CivNav.kt',            drupal: 'packages/drupal/civui/components/nav/nav.component.yml' },
  { name: 'civ-nav-item',          source: 'packages/navigation/src/nav/civ-nav-item.ts',                                             ios: 'packages/ios/Sources/CivUI/CivNavItem.swift',        android: 'packages/android/src/main/kotlin/gov/civui/components/CivNavItem.kt',        drupal: 'packages/drupal/civui/components/nav-item/nav-item.component.yml' },
  { name: 'civ-tabs',              source: 'packages/navigation/src/tabs/civ-tabs.ts',                                                ios: 'packages/ios/Sources/CivUI/CivTabs.swift',           android: 'packages/android/src/main/kotlin/gov/civui/components/CivTabs.kt',           drupal: 'packages/drupal/civui/components/tabs/tabs.component.yml' },
  { name: 'civ-tab',               source: 'packages/navigation/src/tabs/civ-tab.ts',                                                 ios: 'packages/ios/Sources/CivUI/CivTab.swift',            android: 'packages/android/src/main/kotlin/gov/civui/components/CivTab.kt',            drupal: 'packages/drupal/civui/components/tab/tab.component.yml' },
  { name: 'civ-tab-panel',         source: 'packages/navigation/src/tabs/civ-tab-panel.ts',                                           ios: 'packages/ios/Sources/CivUI/CivTabPanel.swift',       android: 'packages/android/src/main/kotlin/gov/civui/components/CivTabPanel.kt',       drupal: 'packages/drupal/civui/components/tab-panel/tab-panel.component.yml' },
  { name: 'civ-side-nav',          source: 'packages/navigation/src/side-nav/civ-side-nav.ts',                                        ios: 'packages/ios/Sources/CivUI/CivSideNav.swift',        android: 'packages/android/src/main/kotlin/gov/civui/components/CivSideNav.kt',        drupal: 'packages/drupal/civui/components/side-nav/side-nav.component.yml' },
  { name: 'civ-side-nav-item',     source: 'packages/navigation/src/side-nav/civ-side-nav-item.ts',                                   ios: 'packages/ios/Sources/CivUI/CivSideNavItem.swift',    android: 'packages/android/src/main/kotlin/gov/civui/components/CivSideNavItem.kt',    drupal: 'packages/drupal/civui/components/side-nav-item/side-nav-item.component.yml' },
  { name: 'civ-on-this-page',      source: 'packages/navigation/src/on-this-page/civ-on-this-page.ts',                                ios: 'packages/ios/Sources/CivUI/CivOnThisPage.swift',     android: 'packages/android/src/main/kotlin/gov/civui/components/CivOnThisPage.kt',     drupal: 'packages/drupal/civui/components/on-this-page/on-this-page.component.yml' },
  { name: 'civ-on-this-page-item', source: 'packages/navigation/src/on-this-page/civ-on-this-page-item.ts',                           ios: 'packages/ios/Sources/CivUI/CivOnThisPageItem.swift', android: 'packages/android/src/main/kotlin/gov/civui/components/CivOnThisPageItem.kt', drupal: 'packages/drupal/civui/components/on-this-page-item/on-this-page-item.component.yml' },
  { name: 'civ-back-to-top',       source: 'packages/navigation/src/back-to-top/civ-back-to-top.ts',                                  ios: 'packages/ios/Sources/CivUI/CivBackToTop.swift',      android: 'packages/android/src/main/kotlin/gov/civui/components/CivBackToTop.kt',      drupal: 'packages/drupal/civui/components/back-to-top/back-to-top.component.yml' },
  { name: 'civ-menu',              source: 'packages/overlays/src/menu/civ-menu.ts',                                                  ios: 'packages/ios/Sources/CivUI/CivMenu.swift',           android: 'packages/android/src/main/kotlin/gov/civui/components/CivMenu.kt',           drupal: 'packages/drupal/civui/components/menu/menu.component.yml' },
  { name: 'civ-menu-item',         source: 'packages/overlays/src/menu/civ-menu-item.ts',                                             ios: 'packages/ios/Sources/CivUI/CivMenuItem.swift',       android: 'packages/android/src/main/kotlin/gov/civui/components/CivMenuItem.kt',       drupal: 'packages/drupal/civui/components/menu-item/menu-item.component.yml' },
  { name: 'civ-pagination',        source: 'packages/data/src/pagination/civ-pagination.ts',                                        ios: 'packages/ios/Sources/CivUI/CivPagination.swift',     android: 'packages/android/src/main/kotlin/gov/civui/components/CivPagination.kt',     drupal: 'packages/drupal/civui/components/pagination/pagination.component.yml' },
  { name: 'civ-data-grid',         source: 'packages/data/src/data-grid/civ-data-grid.ts',                                          ios: 'packages/ios/Sources/CivUI/CivDataGrid.swift',       android: 'packages/android/src/main/kotlin/gov/civui/components/CivDataGrid.kt',       drupal: 'packages/drupal/civui/components/data-grid/data-grid.component.yml' },
  { name: 'civ-toolbar',           source: 'packages/data/src/toolbar/civ-toolbar.ts',                                              ios: 'packages/ios/Sources/CivUI/CivToolbar.swift',        android: 'packages/android/src/main/kotlin/gov/civui/components/CivToolbar.kt',        drupal: 'packages/drupal/civui/components/toolbar/toolbar.component.yml' },
  { name: 'civ-bulk-actions',      source: 'packages/data/src/bulk-actions/civ-bulk-actions.ts',                                    ios: 'packages/ios/Sources/CivUI/CivBulkActions.swift',    android: 'packages/android/src/main/kotlin/gov/civui/components/CivBulkActions.kt',    drupal: 'packages/drupal/civui/components/bulk-actions/bulk-actions.component.yml' },
  { name: 'civ-column-visibility', source: 'packages/data/src/column-visibility/civ-column-visibility.ts',                          ios: 'packages/ios/Sources/CivUI/CivColumnVisibility.swift', android: 'packages/android/src/main/kotlin/gov/civui/components/CivColumnVisibility.kt', drupal: 'packages/drupal/civui/components/column-visibility/column-visibility.component.yml' },
  { name: 'civ-action-chip',       source: 'packages/actions/src/action-chip/civ-action-chip.ts',                                    ios: 'packages/ios/Sources/CivUI/CivActionChip.swift',     android: 'packages/android/src/main/kotlin/gov/civui/components/CivActionChip.kt',     drupal: 'packages/drupal/civui/components/action-chip/action-chip.component.yml' },
  { name: 'civ-input-chip',        source: 'packages/actions/src/input-chip/civ-input-chip.ts',                                      ios: 'packages/ios/Sources/CivUI/CivInputChip.swift',      android: 'packages/android/src/main/kotlin/gov/civui/components/CivInputChip.kt',      drupal: 'packages/drupal/civui/components/input-chip/input-chip.component.yml' },
  { name: 'civ-callout',           source: 'packages/feedback/src/callout/civ-callout.ts',                                           ios: 'packages/ios/Sources/CivUI/CivCallout.swift',        android: 'packages/android/src/main/kotlin/gov/civui/components/CivCallout.kt',        drupal: 'packages/drupal/civui/components/callout/callout.component.yml' },
  { name: 'civ-image',             source: 'packages/layout/src/image/civ-image.ts',                                                 ios: 'packages/ios/Sources/CivUI/CivImage.swift',          android: 'packages/android/src/main/kotlin/gov/civui/components/CivImage.kt',          drupal: 'packages/drupal/civui/components/image/image.component.yml' },
  { name: 'civ-popover',           source: 'packages/overlays/src/popover/civ-popover.ts',                                           ios: 'packages/ios/Sources/CivUI/CivPopover.swift',        android: 'packages/android/src/main/kotlin/gov/civui/components/CivPopover.kt',        drupal: 'packages/drupal/civui/components/popover/popover.component.yml' },
  { name: 'civ-skeleton',          source: 'packages/feedback/src/skeleton/civ-skeleton.ts',                                         ios: 'packages/ios/Sources/CivUI/CivSkeleton.swift',       android: 'packages/android/src/main/kotlin/gov/civui/components/CivSkeleton.kt',       drupal: 'packages/drupal/civui/components/skeleton/skeleton.component.yml' },
  { name: 'civ-spinner',           source: 'packages/feedback/src/spinner/civ-spinner.ts',                                           ios: 'packages/ios/Sources/CivUI/CivSpinner.swift',        android: 'packages/android/src/main/kotlin/gov/civui/components/CivSpinner.kt',        drupal: 'packages/drupal/civui/components/spinner/spinner.component.yml' },
  { name: 'civ-tab-nav',           source: 'packages/navigation/src/tab-nav/civ-tab-nav.ts',                                         ios: 'packages/ios/Sources/CivUI/CivTabNav.swift',         android: 'packages/android/src/main/kotlin/gov/civui/components/CivTabNav.kt',         drupal: 'packages/drupal/civui/components/tab-nav/tab-nav.component.yml' },
  { name: 'civ-tab-nav-item',      source: 'packages/navigation/src/tab-nav/civ-tab-nav-item.ts',                                    ios: 'packages/ios/Sources/CivUI/CivTabNavItem.swift',     android: 'packages/android/src/main/kotlin/gov/civui/components/CivTabNavItem.kt',     drupal: 'packages/drupal/civui/components/tab-nav-item/tab-nav-item.component.yml' },
  ...
  { name: 'civ-read-more',         source: 'packages/layout/src/read-more/civ-read-more.ts',                                          ios: 'packages/ios/Sources/CivUI/CivReadMore.swift',      android: 'packages/android/src/main/kotlin/gov/civui/components/CivReadMore.kt',      drupal: 'packages/drupal/civui/components/read-more/read-more.component.yml' },
  ...
  { name: 'civ-text-button',       source: 'packages/actions/src/text-button/civ-text-button.ts',                                      ios: 'packages/ios/Sources/CivUI/CivTextButton.swift',    android: 'packages/android/src/main/kotlin/gov/civui/components/CivTextButton.kt',    drupal: 'packages/drupal/civui/components/text-button/text-button.component.yml' },
  { name: 'civ-confirm-button',    source: 'packages/actions/src/confirm-button/civ-confirm-button.ts',                                ios: 'packages/ios/Sources/CivUI/CivConfirmButton.swift', android: 'packages/android/src/main/kotlin/gov/civui/components/CivConfirmButton.kt', drupal: 'packages/drupal/civui/components/confirm-button/confirm-button.component.yml' },
  { name: 'civ-toggle-button',     source: 'packages/actions/src/toggle-button/civ-toggle-button.ts',                                  ios: 'packages/ios/Sources/CivUI/CivToggleButton.swift',  android: 'packages/android/src/main/kotlin/gov/civui/components/CivToggleButton.kt',  drupal: 'packages/drupal/civui/components/toggle-button/toggle-button.component.yml' },
  ...
  // Each one has its own iOS / Android / Drupal SDC counterpart so the
  // contract surface (mode, international, extended, allowNegative, etc.)
  // stays parity-checked across platforms.
  { name: 'civ-country',           source: 'packages/inputs/src/country/civ-country.ts',                                              ios: 'packages/ios/Sources/CivUI/CivCountry.swift',       android: 'packages/android/src/main/kotlin/gov/civui/components/CivCountry.kt',       drupal: 'packages/drupal/civui/components/country/country.component.yml' },
  { name: 'civ-currency',          source: 'packages/inputs/src/currency/civ-currency.ts',                                            ios: 'packages/ios/Sources/CivUI/CivCurrency.swift',      android: 'packages/android/src/main/kotlin/gov/civui/components/CivCurrency.kt',      drupal: 'packages/drupal/civui/components/currency/currency.component.yml' },
  { name: 'civ-ein',               source: 'packages/inputs/src/ein/civ-ein.ts',                                                      ios: 'packages/ios/Sources/CivUI/CivEin.swift',           android: 'packages/android/src/main/kotlin/gov/civui/components/CivEin.kt',           drupal: 'packages/drupal/civui/components/ein/ein.component.yml' },
  { name: 'civ-email',             source: 'packages/inputs/src/email/civ-email.ts',                                                  ios: 'packages/ios/Sources/CivUI/CivEmail.swift',         android: 'packages/android/src/main/kotlin/gov/civui/components/CivEmail.kt',         drupal: 'packages/drupal/civui/components/email/email.component.yml' },
  { name: 'civ-phone',             source: 'packages/inputs/src/phone/civ-phone.ts',                                                  ios: 'packages/ios/Sources/CivUI/CivPhone.swift',         android: 'packages/android/src/main/kotlin/gov/civui/components/CivPhone.kt',         drupal: 'packages/drupal/civui/components/phone/phone.component.yml' },
  { name: 'civ-routing-number',    source: 'packages/inputs/src/routing-number/civ-routing-number.ts',                                ios: 'packages/ios/Sources/CivUI/CivRoutingNumber.swift', android: 'packages/android/src/main/kotlin/gov/civui/components/CivRoutingNumber.kt', drupal: 'packages/drupal/civui/components/routing-number/routing-number.component.yml' },
  { name: 'civ-ssn',               source: 'packages/inputs/src/ssn/civ-ssn.ts',                                                      ios: 'packages/ios/Sources/CivUI/CivSsn.swift',           android: 'packages/android/src/main/kotlin/gov/civui/components/CivSsn.kt',           drupal: 'packages/drupal/civui/components/ssn/ssn.component.yml' },
  { name: 'civ-va-file-number',    source: 'packages/inputs/src/va-file-number/civ-va-file-number.ts',                                ios: 'packages/ios/Sources/CivUI/CivVaFileNumber.swift',  android: 'packages/android/src/main/kotlin/gov/civui/components/CivVaFileNumber.kt',  drupal: 'packages/drupal/civui/components/va-file-number/va-file-number.component.yml' },
  { name: 'civ-zip',               source: 'packages/inputs/src/zip/civ-zip.ts',                                                      ios: 'packages/ios/Sources/CivUI/CivZip.swift',           android: 'packages/android/src/main/kotlin/gov/civui/components/CivZip.kt',           drupal: 'packages/drupal/civui/components/zip/zip.component.yml' },
  // Layout primitives — image-preview + input-group both have iOS/Android/Drupal stubs.
  { name: 'civ-image-preview',     source: 'packages/layout/src/image-preview/civ-image-preview.ts',                                  ios: 'packages/ios/Sources/CivUI/CivImagePreview.swift',  android: 'packages/android/src/main/kotlin/gov/civui/components/CivImagePreview.kt',  drupal: 'packages/drupal/civui/components/image-preview/image-preview.component.yml' },
  { name: 'civ-input-group',       source: 'packages/layout/src/input-group/civ-input-group.ts',                                      ios: 'packages/ios/Sources/CivUI/CivInputGroup.swift',    android: 'packages/android/src/main/kotlin/gov/civui/components/CivInputGroup.kt',    drupal: 'packages/drupal/civui/components/input-group/input-group.component.yml' },
];
...
export function diffProps(schema: SchemaProp[], lit: LitProp[]): PropDrift {
  ...
  for (const litProp of lit) {
    ...
    // Skip type check for webOnly props — they exist in the schema for
    // documentation, but the Lit source is the canonical type. JS-only
    // properties (`attribute: false` arrays/objects) read as `string` on
    // the Lit side because no `type:` is declared on the decorator, but
    // the schema describes the conceptual data shape (`array`).
    if (!schemaProp.webOnly && normalizeType(schemaProp.type) !== normalizeType(litProp.type)) {
      mismatched.push({
        name: litProp.name,
        field: 'type',
