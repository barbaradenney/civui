...
export const Default: Story = {
  ...
  render: (args) => html`
    <civ-textarea label="${args.label}" name="${args.name}" hint="${args.hint || ''}" error="${args.error || ''}" placeholder="${args.placeholder || ''}" rows="${args.rows || 5}" ?required="${args.required}" ?disabled="${args.disabled}"></civ-textarea>
  `,
};
...
export const WithHint: Story = {
  render: () => html`
    <civ-textarea label="Reason for applying" name="reason" hint="Describe why you are applying for this benefit in your own words"></civ-textarea>
  `,
};

export const WithError: Story = {
  render: () => html`
    <civ-textarea label="Reason for applying" name="reason" error="Enter a reason for applying" required></civ-textarea>
  `,
};

export const Required: Story = {
  render: () => html`
    <civ-textarea label="Description of incident" name="description" required></civ-textarea>
  `,
};

export const Disabled: Story = {
  render: () => html`
    <civ-textarea label="Previous submission" name="previous" value="This field cannot be edited after submission." disabled></civ-textarea>
  `,
};

export const WithCharacterCount: Story = {
  render: () => html`
    <civ-textarea label="Personal statement" name="statement" hint="Summarize your qualifications" maxlength="500"></civ-textarea>
  `,
};

export const WithWordCount: Story = {
  render: () => html`
    <civ-textarea label="Personal statement" name="statement" hint="Describe your qualifications in 250 words or fewer" maxwords="250" rows="8"></civ-textarea>
  `,
};
...
export const ValidateLength: Story = {
  ...
  render: () => html`
    <civ-textarea label="Why you're applying" name="why" hint="Tell us in a few sentences. Minimum 20 characters, maximum 500." validate="length" minlength="20" maxlength="500"></civ-textarea>
  `,
};
