...
describe('civ-file-upload', () => {
  it('renders with a label', async () => {
    const el = createFixture('<civ-file-upload label="Upload document"></civ-file-upload>');
  ...
  it('renders a hidden file input', async () => {
    const el = createFixture('<civ-file-upload label="Upload" name="file"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('renders a dropzone', async () => {
    const el = createFixture('<civ-file-upload label="Upload"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('shows accepted file types', async () => {
    const el = createFixture('<civ-file-upload label="Upload" accept=".pdf,.jpg"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('shows max file size', async () => {
    const el = createFixture('<civ-file-upload label="Upload" max-size="5242880"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('sets accept on file input', async () => {
    const el = createFixture('<civ-file-upload label="Upload" accept="image/*"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('sets multiple on file input', async () => {
    const el = createFixture('<civ-file-upload label="Upload" multiple></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('renders error with alert role', async () => {
    const el = createFixture('<civ-file-upload label="Upload" error="File too large"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('shows required indicator', async () => {
    const el = createFixture('<civ-file-upload label="Upload" required></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('renders hint text', async () => {
    const el = createFixture('<civ-file-upload label="Upload" hint="PDF or image files only"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('applies focus-visible ring class to dropzone', async () => {
    const el = createFixture('<civ-file-upload label="Upload" name="doc"></civ-file-upload>');
    await waitForUpdate(el);
  ...
  it('applies focus-visible ring class to Remove button', async () => {
    const el = createFixture('<civ-file-upload label="Upload" name="doc"></civ-file-upload>') as any;
    await waitForUpdate(el);
  ...
  describe('i18n overrides', () => {
    it('uses custom drag-text', async () => {
      const el = createFixture('<civ-file-upload label="Upload" drag-text="Arrastra archivos aquí o"></civ-file-upload>');
      await waitForUpdate(el);
    ...
    it('uses custom browse-text', async () => {
      const el = createFixture('<civ-file-upload label="Upload" browse-text="elegir de carpeta"></civ-file-upload>');
      await waitForUpdate(el);
    ...
    it('uses custom remove-text and remove-aria-label', async () => {
      const el = createFixture('<civ-file-upload label="Upload" remove-text="Eliminar" remove-aria-label="Eliminar {name}"></civ-file-upload>') as any;
      await waitForUpdate(el);
    ...
    it('uses custom file-size-error with interpolation', async () => {
      const el = createFixture('<civ-file-upload label="Upload" max-size="1024" file-size-error="{name} supera el tamaño máximo de {size}"></civ-file-upload>') as any;
      await waitForUpdate(el);
    ...
    it('uses custom files-list-label', async () => {
      const el = createFixture('<civ-file-upload label="Upload" files-list-label="Archivos seleccionados"></civ-file-upload>') as any;
      await waitForUpdate(el);
  ...
  describe('analytics', () => {
    ...
    it('suppresses analytics when disable-analytics is set', async () => {
      const el = createFixture('<civ-file-upload label="Upload" name="doc" disable-analytics></civ-file-upload>') as any;
      await waitForUpdate(el);
