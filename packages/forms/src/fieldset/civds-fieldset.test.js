...
afterEach(cleanup);
describe('civds-fieldset', () => {
    it('renders a native fieldset', async () => {
        const el = createFixture('<civds-fieldset legend="Personal info"></civds-fieldset>');
    ...
    it('renders hint text', async () => {
        const el = createFixture('<civds-fieldset legend="Address" hint="Your mailing address"></civds-fieldset>');
        await waitForUpdate(el);
    ...
    it('renders error with alert role', async () => {
        const el = createFixture('<civds-fieldset legend="Address" error="Address is incomplete"></civds-fieldset>');
        await waitForUpdate(el);
    ...
    it('sets aria-describedby on fieldset', async () => {
        const el = createFixture('<civds-fieldset legend="Address" hint="Required" error="Missing"></civds-fieldset>');
        await waitForUpdate(el);
    ...
    it('shows required indicator on legend', async () => {
        const el = createFixture('<civds-fieldset legend="Address" required></civds-fieldset>');
        await waitForUpdate(el);
    ...
    it('uses Light DOM', async () => {
        const el = createFixture('<civds-fieldset legend="Info"></civds-fieldset>');
        await waitForUpdate(el);
        expect(el.shadowRoot).toBeNull();
    });
});
//# sourceMappingURL=civds-fieldset.test.js.map