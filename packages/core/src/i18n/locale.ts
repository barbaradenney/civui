...
const defaultStrings: CivLocaleStrings = {
  ...
  maskPhoneIntlHint: 'Include country code if outside the US (e.g., +44 7700 900123)',
  ...
  maskPhoneIntlError: 'Enter a phone number with 7 to 15 digits',
  ...
  validatePhoneIntl: 'Enter a phone number with 7 to 15 digits (include country code if outside the US)',
