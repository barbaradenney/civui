...
const config: StorybookConfig = {
  ...
  viteFinal: async (config) => {
    ...
    config.resolve.alias = {
      ...
      '@civui/form-patterns/confirmation-panel': resolve(root, 'packages/form-patterns/src/confirmation-panel/index.ts'),
      ...
      '@civui/feedback/activity-timeline': resolve(root, 'packages/feedback/src/activity-timeline/index.ts'),
