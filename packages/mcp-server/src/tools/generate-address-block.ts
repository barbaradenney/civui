...
export function generateAddressBlock(options?: {
  ...
  const htmlLines: string[] = [
    ...
    ``,
    `  <div class="civ-mb-4">`,
    `    <civ-form-field label="Street address line 2" hint="Apartment, suite, unit, building, floor, etc.">`,
    `      <civ-text-input`,
    `        name="street-2"`,
    ...
    `          required`,
    `          preset="us-state"`,
    ...(includeTerritories || includeMilitary ? [`          preset-variant="territories"`] : []),
    `        ></civ-select>`,
    `      </civ-form-field>`,
    `    </div>`,
    ``,
    `    <div class="civ-mb-4">`,
    `      <civ-form-field label="ZIP code" hint="For example: 12345 or 12345-6789" required>`,
    `        <civ-text-input`,
    `          name="zip"`,
