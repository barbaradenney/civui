...
> **Contract reference:** [`civ-radio-group`](pathname:///civui/storybook/?path=/docs/contract-civ-radio-group--docs) — auto-generated structured contract for cross-platform implementation.
