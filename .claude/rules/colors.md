...
1. **Fix `civ-dropzone__icon` low contrast** — change `color: var(--civ-color-base-light)` (2.24:1) to `color: var(--civ-color-base-dark)` (6.74:1) on `.civ-dropzone__icon`. One-line fix. Brings the file-upload icon into SC 1.4.11 compliance.
