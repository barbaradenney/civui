...
const TAG_TO_PACKAGE: Record<string, string> = {
  ...
  'civ-checkbox': '@civui/inputs',
  'civ-checkbox-group': '@civui/inputs',
  'civ-radio': '@civui/inputs',
  'civ-radio-group': '@civui/inputs',
  'civ-segmented-control': '@civui/inputs',
  'civ-segment': '@civui/inputs',
