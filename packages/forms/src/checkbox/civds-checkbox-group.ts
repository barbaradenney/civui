 ...
 *
 * @fires civds-change - When the set of checked values changes
 */
@customElement('civds-checkbox-group')
export class CivdsCheckboxGroup extends CivdsFormElement {
  ...
  override render() {
    ...
    const slotClasses =
      this.orientation === 'horizontal'
        ? 'civds-flex civds-flex-row civds-flex-wrap civds-gap-4'
        : 'civds-flex civds-flex-col civds-gap-1';
  ...
  private _getCheckboxes(): NodeListOf<Element> {
    return this.querySelectorAll('civds-checkbox');
  }
