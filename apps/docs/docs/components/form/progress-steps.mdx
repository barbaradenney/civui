...
<StoryEmbed id="forms-form-progress-steps--default" />

### With Hint

<StoryEmbed id="forms-form-progress-steps--with-hint" />

### With Error

<StoryEmbed id="forms-form-progress-steps--with-error" />

### Required

<StoryEmbed id="forms-form-progress-steps--required" />

### Disabled

<StoryEmbed id="forms-form-progress-steps--disabled" />

### With Descriptions

<StoryEmbed id="forms-form-progress-steps--with-descriptions" />

### Clickable

<StoryEmbed id="forms-form-progress-steps--clickable" />

### All States

<StoryEmbed id="forms-form-progress-steps--all-states" />

### Density Scale

<StoryEmbed id="forms-form-progress-steps--density-scale" />

### Progress Bar

<StoryEmbed id="forms-form-progress-steps--progress-bar" />

### Progress Bar Complete

<StoryEmbed id="forms-form-progress-steps--progress-bar-complete" />

### Government Application Progress

<StoryEmbed id="forms-form-progress-steps--government-application-progress" />

[Open in Storybook →](pathname:///civui/storybook/?path=/story/forms-form-progress-steps--default)
