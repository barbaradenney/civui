...
<StoryEmbed id="forms-patterns-form-step--with-hint" />
...
<StoryEmbed id="forms-patterns-form-step--required" />

### Navigation Disabled

<StoryEmbed id="forms-patterns-form-step--disabled" />

### All States

<StoryEmbed id="forms-patterns-form-step--all-states" />

### Density Scale

<StoryEmbed id="forms-patterns-form-step--density-scale" />

### Usage: Benefit Application Flow

<StoryEmbed id="forms-patterns-form-step--government-benefit-application" />

[Open in Storybook →](pathname:///civui/storybook/?path=/story/forms-patterns-form-step--default)
